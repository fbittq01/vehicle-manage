...
// Video streaming với Range request support
app.get('/uploads/access-logs/videos/:filename', (req, res) => {
  const filename = req.params.filename;
  const filePath = path.join(process.cwd(), 'uploads', 'access-logs', 'videos', filename);
  ...
  if (range) {
    ...
    // Không có range header, gửi toàn bộ file
    const head = {
